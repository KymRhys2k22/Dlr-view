                ...
                <div key={record.id} className="p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 hover:bg-slate-50/50 transition-colors">
                  ...
                  <div className="space-y-1.5 flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="inline-flex items-center justify-center font-mono font-bold text-[11px] text-slate-700 bg-black/[0.04] px-2 py-0.5 rounded-md border border-black/[0.06] sf-caption">
                        #{index + 1}
                      </span>
